...
function(u, c) {
    ...
    function e(t, i) {
        if (t.closest(".popupwindow").length) Z("jQuery PopupWindow is already initialized on this element");
            ...
            var e = u.extend(!0, {},
            g, i);
            e.animationTime = parseInt(e.animationTime, 10),
            e.height = parseInt(e.height, 10),
            e.width = parseInt(e.width, 10),
            e.maxHeight = parseInt(e.maxHeight, 10) || 0,
            e.maxWidth = parseInt(e.maxWidth, 10) || 0,
            e.minHeight = parseInt(e.minHeight, 10) || 0,
            e.minWidth = parseInt(e.minWidth, 10) || 0;
            var o = u("<div>", {
            ...
            e.draggable && p.addClass("popupwindow_titlebar_draggable"),
            u("<div>", {
                class: "popupwindow_titlebar_text",
                text: e.title
            }).css(z).css("order", d ? 1 : 5).appendTo(p),
			// 最大化和删除按钮注掉
            // e.buttons.close && u("<div>", {
            //     class: "popupwindow_titlebar_button popupwindow_titlebar_button_close"
            // }).css(_).css("order", d ? 5 : 1).attr("title", e.buttonsTexts.close).on("click", $).append(D.close).appendTo(p),
            // e.buttons.maximize && u("<div>", {
            //     class: "popupwindow_titlebar_button popupwindow_titlebar_button_maximize"
            // }).css(_).css("order", d ? 4 : 2).attr("title", e.buttonsTexts.maximize).on("click", tt).append(D.maximize).appendTo(p),
            e.buttons.collapse && u("<div>", {
                class: "popupwindow_titlebar_button popupwindow_titlebar_button_collapse"
            }).css(_).css("order", 3).attr("title", e.buttonsTexts.collapse).on("click", it).append(D.collapse).appendTo(p),
            e.buttons.minimize && u("<div>", {
                class: "popupwindow_titlebar_button popupwindow_titlebar_button_minimize"
            }).css(_).css("order", d ? 2 : 4).attr("title", e.buttonsTexts.minimize).on("click", et).append(D.minimize).appendTo(p);
            var r = u("<div>", {
    ...
    function o(t) {
        U(t) && t.data("opened") && (t.data("minimized") && l(t), t.data("overlay").hide(), t.data("opened", !1), N(t, "close"))
    }
    function n(t) {
        if (U(t) && t.data("opened") && !t.data("maximized") && !t.data("collapsed") && !t.data("minimized")) {
            ...
            i.draggable && t.find(".popupwindow_titlebar").removeClass("popupwindow_titlebar_draggable"),
            i.modal || t.data("overlay").css("background-color", "transparent").width("100%").height("100%"),
            j(t),
            F(t);
            var e = L(t, {
                top: 0,
    ...
    function a(t) {
        if (U(t) && t.data("opened") && t.data("maximized")) {
            ...
            e = A(t),
            o = R(t);
            return t.find(".popupwindow_titlebar_button_maximize").empty().append(D.maximize).attr("title", i.buttonsTexts.maximize),
            t.find(".popupwindow_statusbar_handle *, .popupwindow_resizer, .popupwindow_titlebar_button_collapse").show(),
            i.draggable && t.find(".popupwindow_titlebar").addClass("popupwindow_titlebar_draggable"),
            i.modal || t.data("overlay").width(0).height(0).css("background-color", ""),
            u.when(e, o).then(function() {
                t.data("maximized", !1),
                N(t, "unmaximize")
            })
        }
    ...
    function s(t) {
        if (U(t) && t.data("opened") && !t.data("maximized") && !t.data("collapsed") && !t.data("minimized")) {
            ...
            t.find(".popupwindow_content, .popupwindow_statusbar, .popupwindow_resizer, .popupwindow_titlebar_button_maximize, .popupwindow_titlebar_button_minimize").hide(),
            F(t);
            var e = G(t, {
    ...
    function d(t) {
        if (U(t) && t.data("opened") && t.data("collapsed")) {
            ...
            t.find(".popupwindow_content, .popupwindow_statusbar, .popupwindow_resizer, .popupwindow_titlebar_button_maximize, .popupwindow_titlebar_button_minimize").show(),
            u.when(e).then(function() {
                t.data("collapsed", !1),
                N(t, "uncollapse")
            })
        }
    ...
    function p(s) {
        if (U(s) && s.data("opened") && !s.data("collapsed") && !s.data("minimized")) {
            ...
            if (s.data("maximized")) {
                ...
                p.animationTime = p.animationTime / B.secondaryAnimationTimeFactor,
                t = a(s),
                p.animationTime = i
            } else j(s),
            F(s),
            t = u.Deferred().resolve();
            return u.when(t).then(function() {
                s.addClass("popupwindow_minimized").width(""),
                s.find(".popupwindow_titlebar_button_minimize").attr("title", p.buttonsTexts.unminimize),
                s.find(".popupwindow_content, .popupwindow_statusbar, .popupwindow_resizer, .popupwindow_titlebar_button_maximize, .popupwindow_titlebar_button_collapse").hide(),
                p.draggable && s.find(".popupwindow_titlebar").removeClass("popupwindow_titlebar_draggable");
    ...
    function l(t) {
        if (U(t) && t.data("opened") && t.data("minimized")) {
            ...
            t.removeClass("popupwindow_minimized"),
            t.find(".popupwindow_titlebar_button_minimize").attr("title", i.buttonsTexts.minimize),
            t.find(".popupwindow_content, .popupwindow_statusbar, .popupwindow_resizer, .popupwindow_titlebar_button_maximize, .popupwindow_titlebar_button_collapse").show(),
            i.draggable && t.find(".popupwindow_titlebar").addClass("popupwindow_titlebar_draggable"),
            e.show().insertAfter(t.data("overlay"));
            var o = {
                width: e.outerWidth(),
            ...
            n = {},
            a = e.position();
            "horizontal" == r.direction ? (n.width = 0, e.width(o.width)) : (n.height = 0, e.height(o.height)),
            t.css({
                position: "absolute",
                top: a.top,
                left: a.left,
        ...
        if (U(t)) {
            ...
            if (i.check) {
                ...
                if (o.keepInViewport) {
                    var s = q(t),
                    d = u(window);
                    a.top > d.height() - s.height && (a.top = d.height() - s.height),
                    a.left > d.width() - s.width && (a.left = d.width() - s.width),
                    a.top < 0 && (a.top = 0),
                    a.left < 0 && (a.left = 0)
                }
            }
    ...
    function G(t, i) {
        if (U(t)) {
            ...
            if (i.checkSize) {
                if (!t.data("opened") || t.data("maximized") || t.data("minimized")) return;
                o.maxWidth && a.width > o.maxWidth && (a.width = o.maxWidth),
                o.minWidth && a.width < o.minWidth && (a.width = o.minWidth),
                o.maxHeight && a.height > o.maxHeight && (a.height = o.maxHeight),
                o.minHeight && a.height < o.minHeight && (a.height = o.minHeight),
                t.data("collapsed") && (t.data("savedSize", u.extend({},
                a)), delete a.height)
            }
            var s = q(t);
    ...
    function K(t) {
        t.popupWindow.fadeTo(0, t.opacity),
        t.popupWindow.data("settings").mouseMoveEvents || t.popupWindow.data("tempSavedData", {
    ...
    function N(t, i) {
        ...
        "move" == i && (e = h(t)),
        "resize" == i && (e = q(t)),
        t.data("originalTarget").trigger(i + ".popupwindow", e)
    }
    function i() {
        var t = {};
        "horizontal" == r.direction ? (t["flex-direction"] = 0 <= r.position.indexOf("left") ? "row": "row-reverse", t["flex-wrap"] = 0 <= r.position.indexOf("top") ? "wrap": "wrap-reverse") : (t["flex-direction"] = 0 <= r.position.indexOf("top") ? "column": "column-reverse", t["flex-wrap"] = 0 <= r.position.indexOf("left") ? "wrap": "wrap-reverse"),
        m.css(t)
    }
    function U(t) {
    ...
    function ot(t) {
        ...
        e = h(i),
        o = i.data("settings");
        o.modal || i.data("overlay").css("background-color", "transparent").width("100%").height("100%"),
        K({
            popupWindow: i,
            action: "drag",
    ...
    function at(t) {
        ...
        case "drag":
            if (a.top = t.pageY - t.data.compensationY, a.left = t.pageX - t.data.compensationX, e.keepInViewport) {
                ...
                a.top < 0 && (a.top = 0),
                a.left < 0 && (a.left = 0),
                a.top > p.height() - d.height && (a.top = p.height() - d.height),
                a.left > p.width() - d.width && (a.left = p.width() - d.width)
            }
            break;
        case "resize":
        ...
        } (a.top !== c && a.top != o.top || a.left !== c && a.left != o.left) && (i.css(a), w(i, a), e.mouseMoveEvents && N(i, "move")),
        (s.width !== c && s.width != n.width || s.height !== c && s.height != n.height) && (i.outerWidth(s.width).outerHeight(s.height), Q(i, s), e.mouseMoveEvents && N(i, "resize"))
    }
    function st(t) {
        var i = t.data.popupWindow,
        e = i.data("settings");
        if (i.fadeTo(0, 1), u(document).off("mousemove", at).off("mouseup", st), e.modal || i.data("overlay").width(0).height(0).css("background-color", ""), !e.mouseMoveEvents) {
            ...
            a.position.top == o.top && a.position.left == o.left || N(i, "move"),
            a.size.width == n.width && a.size.height == n.height || N(i, "resize"),
    ...
    function dt(t) {
        ...
        case "dragend":
            ...
            if (i.keepInViewport) {
                ...
                n.top < 0 && (n.top = 0),
                n.left < 0 && (n.left = 0),
                n.top > s.height() - a.height && (n.top = s.height() - a.height),
                n.left > s.width() - a.width && (n.left = s.width() - a.width)
            }
            p.css(u.extend(n, {
                opacity: 1,
                visibility: "visible"
    ...
    u.PopupWindowMinimizedArea = function(t) {
        if (t === c) return u.extend({},
        r);
        t.position && (r.position = (0 <= t.position.toLowerCase().indexOf("b") ? "bottom": "top") + " " + (0 <= t.position.toLowerCase().indexOf("l") ? "left": "right")),
        t.direction && (r.direction = 0 <= t.direction.toLowerCase().indexOf("h") ? "horizontal": "vertical"),
        i()
    },
    u.fn.PopupWindow = function(t, i) {
        ...
        case "setposition":
            return this.each(function() {
                L(u(this).closest(".popupwindow"), u.extend({},
                i, {
                    check: !0,
                    event: !0
                }))
        ...
        case "setsize":
            return this.each(function() {
                G(u(this).closest(".popupwindow"), u.extend({},
                i, {
                    checkSize: !0,
                    checkPosition: !0,
                    event: !0
        ...
        case "getstate":
            return this[0] ?
            function(t) {
                return t.length ? t.data("opened") ? t.data("minimized") ? "minimized": t.data("collapsed") ? "collapsed": t.data("maximized") ? "maximized": "normal": "closed": c
        ...
        case "settitle":
            return this.each(function() { !
                function(t, i) {
                    if (!U(t)) return;
                    t.data("settings").title = i,
                    t.find(".popupwindow_titlebar_text").text(i)
                } (u(this).closest(".popupwindow"), i)
            });
        case "statusbar":
            return this.each(function() { !
        ...
        case "destroy":
            return this.each(function() { !
                function(t) {
                    ...
                    i.appendTo(t.data("originalParent")),
